...
cat('<a href="https://afraser.shinyapps.io/shiny/" target="_blank" onclick="window.open(\'https://afraser.shinyapps.io/shiny/\', \'newwindow\', \'width=600,height=600\'); return false;">Launch popup</a>')
```
...
```{r modelCompare, message=FALSE, warning=FALSE,eval=FALSE}
library(caret)
library(randomForest)
