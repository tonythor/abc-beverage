...
We'll predict not from the model where outliers are removed form the last section, but from further back hwere we only removed th columns. Removing outliers makes good fits and charts and such, but it might be too heavy handed. That should be a choice by the staekholders. 
